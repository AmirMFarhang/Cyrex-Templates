...
class SessionManager
{
    ...
    public function AddSession(string $username , string $ip): string
    {
        ...
        echo 'added';
        $this->sess->set($code, array('user' => $username, 'ts' => time(), 'ip' => $ip) );
        return $code;
    }
    ...
    public function ReturnSessionSch(string $sid): string
    {
        $data = $this->sess->get($sid, 'sch');
        echo $data;
        return $data;
    }

    public function ReturnSessionCls(string $sid): string
    {
        $data = $this->sess->get($sid, 'cls');
        echo $data;
        return $data;
    }
